...
class CharacterFrequencyNested {
    ...
    // Finds character frequency using nested loops
    static String[] findCharacterFrequency(String text) {
        ...
        // 1D array to store character and frequency
        String[] result = new String[count];
        int index = 0;

        // Store final character-frequency pairs
        for (int i = 0; i < chars.length; i++) {
            if (chars[i] != '0') {
    ...
    static void displayResult(String[] data) {
        ...
        // Loop to print each character frequency
